...
The iOS boot camp, marketed as slightly more difficult than the web dev boot camp, was phased out due to the changing job market. After the explosion of Apple’s App Store, mobile development plateaued enough that demand for dedicated iOS devs dropped. Also, the creation of cross-platform frameworks like [React Native](https://reactnative.dev/) and [Flutter](https://flutter.dev) have obviated the need for native iOS and Android developers (fluent in Swift or Objective-C, and Kotlin, respectively). Since graduating from the web-dev program, the boot-camp company has extended their offerings to include data science and cybersecurity, both burgeoning areas in tech at the moment.
...
Post boot camp is the time to hustle if you don’t have a job offer lined up. To keep up learning, you can either keep taking courses, or, better yet, give yourself a project and teach yourself how to problem solve once you get stuck. If you didn’t give yourself a project before the boot camp, now is the time for one. Google “code project ideas” if you need inspiration.
...
With skills I’ve now learned or sharpened on the job, I have worked on some side projects. One is my personal website, and the feature I’ll highlight here is my [event gallery](https://russellmcwhae.ca/events) from various outdoor trips from over the years. It’s a terrific way to remember all the wild places I’ve explored while being more personal and unique than a shared Google Photos album or similar. Another fun project was an automated [web scraper](https://github.com/rmcwhae/koodo-prepaid-promo-scraper) to check for pre-paid plan promotions on Koodo’s website. While neither of these two projects has any capacity to generate revenue, do not underestimate the importance of tinkering. Passion projects or side hustles can become the next startups, to say nothing of the skills you’ll learn in taking them on.
...
Gone are the days of spending your entire career at the same company. Developers can change jobs as often as every two to three years; this is the quickest way to ramp up your salary if you are so inclined. As your experience increases, new doors will open. Apply for work at your dream organization, take up contracting, work for a startup—or even found a startup.
...
The sheer volume of job opportunities in tech is in stark contrast to the oil patch when I left. My salary has now caught up to what I made as an engineer-in-training in oil and gas (not adjusted for inflation—and wow, does a dollar today go nowhere near as far as one did in 2013), and I get to live, work, and play in a delightful mountain town. I have zero regrets with my career change.
...
> AI recommender overnight…

And how about the real estate market in Silicon Valley:

> Quotation about buying a 600k over 1m asking.
